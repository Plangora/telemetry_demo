defmodule TelemetryDemoWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("telemetry_demo.repo.query.total_time", unit: {:native, :millisecond}),
      summary("telemetry_demo.repo.query.decode_time", unit: {:native, :millisecond}),
